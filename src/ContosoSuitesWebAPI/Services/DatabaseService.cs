...
public class DatabaseService : IDatabaseService
{
        ...
        public async Task<IEnumerable<Booking>> GetBookingsForHotel([Description("The ID of the hotel")] int hotelId)
    {
        ...
        public async Task<IEnumerable<Booking>> GetBookingsByHotelAndMinimumDate([Description("get bookings by hotel and minimum date")] int hotelId, DateTime dt)
    {
        ...
        return bookings;
         ...
         [KernelFunction]
         [Description("Get bookings missinghotel rooms.")]
